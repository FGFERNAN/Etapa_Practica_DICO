...
<div class="container-fluid form-container">
    <form action="<?= base_url('usuarios/actualizar/' . $usuario->id_usuarios) ?>" method="post" class="row g-3 needs-validation" novalidate>
        ...
        <div class="col-6">
            ...
            <input type="tel" value="<?= set_value('telefono', $usuario->telefono) ?>" name="telefono" pattern="[0-9]{10}" placeholder="3107847573" class="form-control" minlength="10" maxlength="10" title="Ingrese 10 dígitos sin espacios" id="telefono" required>
