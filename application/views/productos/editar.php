...
<div class="container-fluid form-container">
    <form action="<?= base_url('productos/actualizar/'.$producto->id) ?>" method="post" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="number" name="precio" value="<?= $producto->precio ?>" step="0.01" min="0" placeholder="0.00" class="form-control" id="precio" required>
        </div>
        <div class="col-12">
        ...
        <div class="col-md-4">
            ...
            <select id="estado" name="estadoID" class="form-select">
                <option value="" disabled>Seleccionar</option>
                <?php foreach ($estados as $e): ?>
                    <option value="<?= $e->id ?>" <?= $producto->estadoID == $e->id ? 'selected' : '' ?>><?= $e->nombre ?></option>
                <?php endforeach; ?>
            </select>
        </div>
