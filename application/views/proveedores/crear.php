...
<div class="container-fluid form-container">
    <form action="<?= base_url('proveedores/guardar') ?>" method="post" class="row g-3 needs-validation" novalidate>
        ...
        <div class="col-md-6">
            <label for="contacto" class="form-label mi-label">Contacto</label>
            <input type="email" name="contacto" value="<?= set_value('contacto') ?>" class="form-control" id="contacto" required>
        ...
        <div class="col-md-6">
            ...
            <input type="tel" name="telefono" value="<?= set_value('telefono') ?>" class="form-control" pattern="[0-9]{10}" placeholder="3001234567" id="telefono" title="Ingrese 10 dígitos sin espacios">
        ...
        <div class="col-md-6">
            <label for="empresa" class="form-label mi-label">Empresa</label>
            <input type="text" name="empresa" value="<?= set_value('empresa') ?>" class="form-control" id="empresa" minlength="3" maxlength="50" required>
        ...
        <div class="col-6">
            <label for="nit" class="form-label mi-label">NIT</label>
