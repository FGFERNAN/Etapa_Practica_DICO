...
class Reportes extends MY_Controller
{
    ...
    public function filtrar()
    {
        ...
        // Crear un array de filtros para pasarlo al modelo
        $filtros = [
            'fecha_inicio' => $fecha_inicio,
            'fecha_fin' => $fecha_fin,
            'tipo_operacion' => $tipo_operacion_limpio
        ];
        ...
        $data['operaciones'] = $this->Reporte_model->filter_by_operation($config['per_page'], $offset, $filtros);
        $data['tipo_operacion'] = $this->Reporte_model->get_all_operations();
        $data['links'] = $this->pagination->create_links();
        $this->load->view('reportes/index', $data);
    }
